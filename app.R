...
#  ),
  bs4DashBody(
    fluidRow(
      bs4ValueBox(subtitle = "Average price (EUR) of listings", bs4ValueBoxOutput("filtered_mean"), width = 6, icon = "thumbs-up", color = "primary"),
      bs4ValueBox(subtitle = "Highest price (EUR) of listings", bs4ValueBoxOutput("filtered_max"), width = 3, icon = "thumbs-down", color = "secondary"),
      bs4ValueBox(subtitle = "Lowest price (EUR) of listings", bs4ValueBoxOutput("filtered_min"), width = 3, icon = "thumbs-up", color = "secondary")
    ),
    tabItems(
